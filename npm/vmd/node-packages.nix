...
let
  sources = {
    ...
    "lowlight-1.14.0" = {
      ...
      version = "1.14.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/lowlight/-/lowlight-1.14.0.tgz";
        sha512 = "N2E7zTM7r1CwbzwspPxJvmjAbxljCPThTFawEX2Z7+P3NGrrvY54u8kyU16IY4qWfoVIxY8SYCS8jTkuG7TqYA==";
      };
    };
    "map-cache-0.2.2" = {
      name = "map-cache";
