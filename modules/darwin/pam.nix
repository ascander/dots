...
# NOTE: copied from https://github.com/LnL7/nix-darwin/pull/787 
# TODO: remove once https://github.com/LnL7/nix-darwin/pull/1020 is merged
with lib;
let
  ...
  touchIdAuth = ''
    ...
    ${optionalString cfg.touchIdAuth.enable "auth       sufficient     pam_tid.so"}
    EOF
  '';
in
{
  options.security.pam = {
    touchIdAuth.enable = mkEnableOption (
      lib.mdDoc ''
